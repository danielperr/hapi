...
The student can also willingly download a save file. This will create a new activity container, containing
the current activity's structure and the saved answers. More info at [Activity Containers](activity-containers).
